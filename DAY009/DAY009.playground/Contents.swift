...
let ascendingOddLuckyNumber = oddLuckyNumbers.sorted { $0 < $1 }

let formatedAscendingOddLuckyNumber = ascendingOddLuckyNumber.map { "\($0) is a lucky number" }

for luckyNumber in formatedAscendingOddLuckyNumber {
    print(luckyNumber)
}
